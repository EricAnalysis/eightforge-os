// lib/server/heuristicDecisionEngine.ts
// LEGACY: Heuristic decision engine based on extraction mention patterns.
// Preserved for the existing jobs/process pipeline. New rule-based evaluation
// lives in ruleEngine.ts + decisionEngine.ts + workflowEngine.ts.
